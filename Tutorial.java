...
public class Tutorial extends World
{
    ...
    Label tutorial2 = new Label("by holding left click", 40);
    Label tutorial3 = new Label("before they fall to the floor", 40);
    Label tutorial4 = new Label("Don't slice bombs", 40);
    ...
    {    
        ...
        addObject(tutorial4, getWidth()/2, getHeight()/2+75);
